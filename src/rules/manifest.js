...
export const RULES = [
  ...
  { rule: "wcag-1.4.7",  name: "Low or No Background Audio", level: "AAA", wcag: "2.0", how: "static",   detects: "unmuted <audio> — verify background audio is absent, 20dB quieter, or user-switchable (warn-class)" },
  ...
  { rule: "wcag-1.4.9",  name: "Images of Text (No Exception)", level: "AAA", wcag: "2.0", how: "static", detects: "non-logo images carrying text — AAA permits no images of text outside decoration/logotype" },
  ...
  { rule: "wcag-2.2.4",  name: "Interruptions",             level: "AAA", wcag: "2.0", how: "static",    detects: "any <meta http-equiv=refresh> or modal alert/confirm/prompt — AAA bans postponable interruptions outright" },
  ...
  { rule: "wcag-2.3.2",  name: "Three Flashes (AAA)",       level: "AAA", wcag: "2.0", how: "static",    detects: "flashing markup — at AAA nothing may flash at all, even under the A/AA threshold" },
  ...
  { rule: "wcag-3.3.4",  name: "Error Prevention (Legal, Financial, Data)", level: "AA", wcag: "2.0", how: "static", detects: "transactional forms with no check/reverse/confirm mechanism — warn-class" },
  { rule: "wcag-3.3.5",  name: "Help",                      level: "AAA", wcag: "2.0", how: "static",    detects: "substantial forms (3+ fields) with no context-sensitive help mechanism — warn-class" },
  { rule: "wcag-3.3.6",  name: "Error Prevention (All)",    level: "AAA", wcag: "2.0", how: "static",    detects: "any form lacking a check/reverse/confirm step — warn-class" },
  ...
  { rule: "wcag-3.3.9",  name: "Accessible Authentication (Enhanced)", level: "AAA", wcag: "2.2", how: "static", detects: "CAPTCHA/cognitive-challenge markup — AAA exempts no cognitive test" },
  // ── Robust ─────────────────────────────────────────────────────────────
