...
const WCAG_TO_FPC = {
  ...
  "wcag-1.2.2": [FPC.WITHOUT_VISION],
  "wcag-1.2.5": [FPC.WITHOUT_VISION],
  "wcag-1.3.1": [FPC.WITHOUT_VISION],
  "wcag-1.3.2": [FPC.WITHOUT_VISION],
  "wcag-1.3.3": [FPC.WITHOUT_VISION],
  "wcag-1.3.4": [FPC.LIMITED_MANIPULATION],
  "wcag-1.3.5": [FPC.LIMITED_COGNITIVE],
  "wcag-1.4.1": [FPC.COLOR_PERCEPTION],
  "wcag-1.4.2": [FPC.LIMITED_COGNITIVE],
  "wcag-1.4.3": [FPC.LIMITED_VISION, FPC.COLOR_PERCEPTION],
  "wcag-1.4.4": [FPC.LIMITED_VISION],
  "wcag-1.4.5": [FPC.WITHOUT_VISION],
  "wcag-1.4.6": [FPC.LIMITED_VISION, FPC.COLOR_PERCEPTION],
  "wcag-1.4.7": [FPC.LIMITED_COGNITIVE],
  "wcag-1.4.8": [FPC.LIMITED_VISION],
  "wcag-1.4.9": [FPC.WITHOUT_VISION],
  "wcag-1.4.10": [FPC.LIMITED_VISION],
  "wcag-1.4.11": [FPC.LIMITED_VISION],
  "wcag-1.4.12": [FPC.LIMITED_VISION],
  "wcag-1.4.13": [FPC.LIMITED_MANIPULATION, FPC.LIMITED_VISION],
  "wcag-2.1.1": [FPC.LIMITED_MANIPULATION],
  "wcag-2.1.2": [FPC.LIMITED_MANIPULATION],
  "wcag-2.1.3": [FPC.LIMITED_MANIPULATION],
  "wcag-2.1.4": [FPC.LIMITED_MANIPULATION],
  "wcag-2.2.1": [FPC.LIMITED_COGNITIVE],
  "wcag-2.2.2": [FPC.LIMITED_COGNITIVE],
  "wcag-2.2.4": [FPC.LIMITED_COGNITIVE],
  "wcag-2.3.1": [FPC.LIMITED_VISION],
  "wcag-2.3.2": [FPC.LIMITED_VISION],
  "wcag-2.3.3": [FPC.LIMITED_COGNITIVE],
  ...
  "wcag-2.4.10": [FPC.LIMITED_COGNITIVE],
  "wcag-2.4.8":  [FPC.LIMITED_COGNITIVE],
  "wcag-2.4.11": [FPC.LIMITED_VISION],
  "wcag-2.4.12": [FPC.LIMITED_VISION],
  "wcag-2.4.13": [FPC.LIMITED_VISION],
  "wcag-2.5.2": [FPC.LIMITED_MANIPULATION],
  "wcag-2.5.3": [FPC.WITHOUT_VISION],
  "wcag-2.5.4": [FPC.LIMITED_MANIPULATION],
  "wcag-2.5.5": [FPC.LIMITED_MANIPULATION],
  "wcag-2.5.7": [FPC.LIMITED_MANIPULATION],
  "wcag-2.5.8": [FPC.LIMITED_MANIPULATION],
  "wcag-3.1.1": [FPC.LIMITED_COGNITIVE],
  "wcag-3.1.2": [FPC.LIMITED_COGNITIVE],
  "wcag-3.1.4": [FPC.LIMITED_COGNITIVE],
  "wcag-3.1.5": [FPC.LIMITED_COGNITIVE],
  "wcag-3.2.1": [FPC.LIMITED_COGNITIVE],
  "wcag-3.2.2": [FPC.LIMITED_COGNITIVE],
  "wcag-3.2.3": [FPC.LIMITED_COGNITIVE],
  "wcag-3.2.4": [FPC.LIMITED_COGNITIVE],
  "wcag-3.2.5": [FPC.LIMITED_COGNITIVE],
  "wcag-3.2.6": [FPC.LIMITED_COGNITIVE],
  "wcag-3.3.1": [FPC.LIMITED_COGNITIVE],
  "wcag-3.3.2": [FPC.LIMITED_COGNITIVE],
  "wcag-3.3.3": [FPC.LIMITED_COGNITIVE],
  "wcag-3.3.4": [FPC.LIMITED_COGNITIVE],
  "wcag-3.3.5": [FPC.LIMITED_COGNITIVE],
  "wcag-3.3.6": [FPC.LIMITED_COGNITIVE],
  "wcag-3.3.7": [FPC.LIMITED_COGNITIVE],
  "wcag-3.3.8": [FPC.LIMITED_COGNITIVE],
  "wcag-3.3.9": [FPC.LIMITED_COGNITIVE],
  "wcag-4.1.1": [FPC.WITHOUT_VISION],
